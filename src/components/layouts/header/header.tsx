        ...
        <div className='hidden md:block'>
          <nav aria-label='Site Nav'>
            <ul className='flex items-center gap-6 text-sm'>
              ...
              <li>
                <UnderlineLink href='/'>Careers</UnderlineLink>
              </li>

              <li>
                <UnderlineLink href='/'>History</UnderlineLink>
              </li>

              <li>
                <UnderlineLink href='/'>Services</UnderlineLink>
              </li>
              ...
              <li>
                <UnderlineLink href='/'>Blog</UnderlineLink>
              </li>
            </ul>
          </nav>
        </div>
